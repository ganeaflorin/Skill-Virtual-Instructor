    ...
    <main>
        <div class="skivi-presentation">
            ...
            <div class="skivi-presentation__div">
                <p class="skivi-says-hi">Hi<?php echo $name;?>! I'm SkiVI!</p>
        ...
        <div class="paths">
            <div class="path">
                    <a href="/paths/origami" class="path__links">
                ...
                <div class="path">
                    <a href="/paths/tie" class="path__links">
                ...
                <div class="path">
                    <a href="/paths/meals" class="path__links">
