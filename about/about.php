...
<head>
    ...
    <meta name="description" content="How was SkiVI created.">
    <title>SkiVI - About</title>
    <style>
            ...
            <div class="main__path-section">
                ...
                <div class="path-description">
                    ...
                    <p> SkiVI was created by two students enrolled
                        ...
                        At its base, it is a project which has to implement
                        microservices for teaching different types of skills
                        (origami, tie knotting and preparing fast meals) proposed by
                        the coordinator Alexandru Pavaloi for the Web Technologies course.
                    </p>
                </div>
            </div>
        </section>
